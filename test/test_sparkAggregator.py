...
def test_PriceDistribution_Pass():
	...
	data = {'UnitPrice': [0.65,0.85,1.25,1.65,1.69,1.85,2.1,2.55,2.75,2.95,3.39,3.75,4.25,4.95,5.95,7.65,7.95,9.95],
			'Sold Amount': [24.0,60.0,24.0,6.0,32.0,12.0,12.0,6.0,8.0,18.0,18.0,68.0,18.0,12.0,9.0,2.0,8.0,2.0]
		}
...
def test_PriceQuantityRatioPerInvoiceNo_Pass():
	...
	'{"InvoiceNo":"536370","Ratios":["{\\"Sold Amount\\":24.0,\\"UnitPrice\\":\\"0.65\\",\\"Ratio\\":0.027083333333333334}","{\\"Sold Amount\\":60.0,\\"UnitPrice\\":\\"0.85\\",\\"Ratio\\":0.014166666666666666}","{\\"Sold Amount\\":60.0,\\"UnitPrice\\":\\"3.75\\",\\"Ratio\\":0.0625}","{\\"Sold Amount\\":18.0,\\"UnitPrice\\":\\"2.95\\",\\"Ratio\\":0.1638888888888889}","{\\"Sold Amount\\":24.0,\\"UnitPrice\\":\\"1.25\\",\\"Ratio\\":0.052083333333333336}"]}']
